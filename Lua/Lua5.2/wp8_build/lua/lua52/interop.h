...
{	
	...
	public:
		...
		static int LuaGetInfo(intptr_t luaState, string what, intptr_t ar)
		{
			return ::lua_getinfo(TS(luaState), TC(what).c_str(), (lua_Debug*)(void*)ar);
		}

		static int LuaGetStack(intptr_t luaState, int level, intptr_t n) {
			return ::lua_getstack(TS(luaState), level, (lua_Debug*)(void*)n);
		}
